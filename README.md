...
.gitignore
Makefile
main.c                  # argumentos, orquestracao, cronometragem, times.txt
mandelbrot.c / .h       # nucleo: calculo de um ponto + mapeamento + normalizacao
implementacoes.c / .h   # as 4 estrategias (serial, openmp, pthreads1, pthreads2)
imagem.c / .h           # alocacao da matriz e gravacao do .pgm
```
